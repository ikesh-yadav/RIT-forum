...
<?php
  ...
  if(!isset($_SESSION['logged_in'])){
    ...
    if(isset($_POST['post-textarea'])){
      $sql="INSERT INTO `post` (`content`, `thread_id`, `user_id`) VALUES ('".$_POST['post-textarea']."',".$_GET['thread_Id'].",".$_SESSION['id']." )";
      $result=$link->query($sql);
      unset($_POST['post-textarea']);
    }
    ...
    echo "<tr class='add-post'>
              <form method='post'>
                <table>
                  <tr>
                    <td>
                      <textarea class='' rows='10' name='post-textarea'></textarea>
                    </td>
                  </tr>
                  <tr>
                    <td>
